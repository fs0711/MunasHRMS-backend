...
class Leads(models.Model):
    ...
    def update_validation_rules(cls): return {
        constants.LEAD__FIRST_NAME: [{"rule": "datatype", "datatype": str}],
        constants.LEAD__STATUS: [{"rule": "choices", "options": constants.LEAD__STATUS__LIST}],
        constants.LEAD__GENDER: [{"rule": "choices", "options": constants.GENDER_LIST}],
        constants.LEAD__COUNTRY: [{"rule": "datatype", "datatype": str}],
        constants.LEAD__CITY: [{"rule": "datatype", "datatype": str}],
    }
    ...
    def display(self):
        return {
            ...
            constants.LEAD__COMMENT: self[constants.LEAD__COMMENT] if self[constants.LEAD__COMMENT] else '',
    ...
    def display_min(self):
        return {
            ...
            constants.LEAD__COMMENT: self[constants.LEAD__COMMENT][0:250]+ "..."  if self[constants.LEAD__COMMENT] else '',
