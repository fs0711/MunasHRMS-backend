...
from munasHRMS.UserManagement.controllers.TokenController import TokenController
from munasHRMS.generic.services.utils import constants, response_codes, response_utils, common_utils
    ...
    def login_controller(cls, data, platform="web"):
        if platform != constants.PLATFORM_WEB\
            ...
            return response_utils.get_response_object(
                ...
                .format(
                    [constants.PLATFORM_WEB, constants.PLATFORM_MOBILE]),
            )
        is_valid, error_messages = cls.cls_validate_data(data=data,
